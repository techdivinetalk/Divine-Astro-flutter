                ...
                children: [
                        ...
                        child: TextFormField(
                          ...
                          onTap: () {
                            if (widget.controller!.isEmojiShowing.value) {
                              widget.controller!.isEmojiShowing.value = false;
                            }
                          },
                          scrollController:
                              ...
                              children: [
                                !widget.controller!.hasMessage.value
                                  ...
                                  /*FocusManager
                                          ...
                                          ?.unfocus();
                                      AssistantGiftService()
                                          .giftPopup(
                                        isMultiple: true,
                                        context: Get.context!,
                                        userId: (preferenceService
                                            .getUserDetail()
                                            ?.id ??
                                            "")
                                            .toString(),
                                        userName: preferenceService
                                            .getUserDetail()
                                            ?.name ??
                                            "",
                                        astrologerId:
                                        ...
                                        play: (GiftData item,
                                         ...
                                         /// sending gift code
                                          // controller
                                          //     .sendGifts(ChatMessage(
                                          //   productId:
                                          //   item.id.toString(),
                                          //   awsUrl:
                                          //   item.fullGiftImage,
                                          //   title: "",
                                          //   message: item.giftName,
                                          // ));
                                        },
                                      );*/
                                    },
                  ...
                  if (!widget.controller!.hasMessage.value)
                    GestureDetector(
                        ...
                        child: Center(
                          child: SvgPicture.asset(widget.controller!.isRecording.value
                              ? "assets/svgs/new_chat_send.svg"
                              : "assets/svgs/chat_new_mice.svg"),
                        ))
                  else
                    InkWell(
                        onTap: () {
                ...
                child: Row(
                  ...
                  children: [
                    isKundli.value == 1
                        ? GestureDetector(
                        onTap: () {
                          if (widget.controller!.loading != Loading.loading) {
                    ...
                    Obx(
                        ...
                        return widget.controller!.isOfferVisible.value ||
                            isVOIP.toString() == "0"
                            ? const SizedBox()
                          ...
                          checkOppositeSidePermGranted: () {
                            ...
                            widget.controller!.messageController.text = message;
                          ...
                          customData: {
                            ...
                            // "time": "00:20:00",
                            "time": widget.controller!.showTalkTime.value,
                          },
                          isAstrologer: false,
