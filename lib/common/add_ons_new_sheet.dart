...
// import 'colors.dart';
//
// Future<void> addOnsNewSheet(BuildContext context, void Function(String value) onSelect) async {
...
//               mainAxisSize: MainAxisSize.min,
//               children: [
//                 Assets.images.astrologer.image(height: 48.w, width: 48.w),
//                 Text('Tripti',
//                     style: TextStyle(
...
//   const ProductWidget({Key? key, required this.model, required this.onValueChange}) : super(key: key);
//
...
//                         ),
//                         SizedBox(width: 5.h),
//                         CustomText(model.price, fontSize: 16.sp, fontWeight: FontWeight.w600)
//                       ],
//                     ),
//                     Text(
...
//   const CustomCheckMaker({Key? key, this.initialValue = false, required this.onValueChange})
//       : super(key: key);
//
...
//       svg: initialValue ? Assets.svgs.icCheck.svg() : Assets.svgs.icUnCheck.svg(),
//       onPressed: () {
