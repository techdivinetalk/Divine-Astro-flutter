...
class WaitList extends StatelessWidget {
  ...
  WaitList({Key? key,this.onAccept,this.astroId}) : super(key: key);
            ...
            child: Column(
              children: [
                StreamBuilder<DatabaseEvent>(
                  stream: database.ref().child("live/$astroId/waitList").onValue,
                ...
                SizedBox(height: 20.h),
                Obx(()=>controller.nextPerson.isEmpty
                  ? SizedBox() : Align(
                    alignment: Alignment.centerLeft,
                    child: Padding(
                      padding: EdgeInsets.only(left: 21.w),
                ...
                SizedBox(height: 20.h),
                Obx(()=>
                    controller.nextPerson.isEmpty ? SizedBox() : Container(
                    decoration: const BoxDecoration(color: AppColors.white),
                    child: Row(
                      children: [
                        SizedBox(width: 32.w),
                        ...
                        SizedBox(width: 10.w),
                        CustomText(controller.nextPerson["name"] ?? "",
                            fontSize: 20.sp,
                            fontWeight: FontWeight.w500,
                            fontColor: AppColors.darkBlue),
                        const Spacer(),
                ...
                SizedBox(height: 20.h),
                Obx(()=> controller.nextPerson.isEmpty ? SizedBox() :
                  Row(
