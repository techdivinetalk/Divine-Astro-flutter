...
class Response {
  ...
  factory Response.fromJson(Map<String, dynamic> json) => Response(
    conversionRate: json["conversion_rate"] == null ? null : BusyHours.fromJson(json["conversion_rate"]),
    repurchaseRate: json["repurchase_rate"] == null ? null : BusyHours.fromJson(json["repurchase_rate"]),
    onlineHours: json["online_hours"] == null ? null : BusyHours.fromJson(json["online_hours"]),
    liveHours: json["live_hours"] == null ? null : BusyHours.fromJson(json["live_hours"]),
    eCommerce: json["e_commerce"] == null ? null : BusyHours.fromJson(json["e_commerce"]),
    busyHours: json["busy_hours"] == null ? null : BusyHours.fromJson(json["busy_hours"]),
  );
...
class BusyHours {
  ...
  factory BusyHours.fromJson(Map<String, dynamic> json) => BusyHours(
    ...
    rankDetail: json["rank_detail"] == null ? [] : List<RankDetail>.from(json["rank_detail"]!.map((x) => RankDetail.fromJson(x))),
    performance: json["performance"] == null ? [] : List<Performance>.from(json["performance"]!.map((x) => Performance.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "label": label,
    "detail": detail == null ? [] : List<dynamic>.from(detail!.map((x) => x.toJson())),
    "rank_detail": rankDetail == null ? [] : List<dynamic>.from(rankDetail!.map((x) => x.toJson())),
    "performance": performance == null ? [] : List<dynamic>.from(performance!.map((x) => x.toJson())),
  };
}
