...
ManglikDoshModel manglikDoshModelFromJson(String str) =>
    ManglikDoshModel.fromJson(json.decode(str));

String manglikDoshModelToJson(ManglikDoshModel data) =>
...
class ManglikDoshModel {
  ...
  factory ManglikDoshModel.fromJson(Map<String, dynamic> json) =>
      ManglikDoshModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        manglik:
            json["manglik"] == null ? null : Manglik.fromJson(json["manglik"]),
...
class KalsarpaDetails {
  ...
  factory KalsarpaDetails.fromJson(Map<String, dynamic> json) =>
      KalsarpaDetails(
...
class Manglik {
  ...
  factory Manglik.fromJson(Map<String, dynamic> json) => Manglik(
        ...
        manglikCancelRule: json["manglik_cancel_rule"] == null
            ? []
            : List<String>.from(json["manglik_cancel_rule"]!.map((x) => x)),
        ...
        percentageManglikAfterCancellation:
            json["percentage_manglik_after_cancellation"].toString(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "manglik_cancel_rule": manglikCancelRule == null
            ? []
  ...
  factory ManglikPresentRule.fromJson(Map<String, dynamic> json) =>
      ManglikPresentRule(
        basedOnAspect: json["based_on_aspect"] == null
            ? []
            : List<String>.from(json["based_on_aspect"]!.map((x) => x)),
        basedOnHouse: json["based_on_house"] == null
            ? []
            : List<String>.from(json["based_on_house"]!.map((x) => x)),
      );

  Map<String, dynamic> toJson() => {
        "based_on_aspect": basedOnAspect == null
            ? []
            : List<dynamic>.from(basedOnAspect!.map((x) => x)),
        "based_on_house": basedOnHouse == null
            ? []
            : List<dynamic>.from(basedOnHouse!.map((x) => x)),
      };
}
...
class PitraDoshaReport {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "rules_matched": rulesMatched == null
            ? []
            : List<dynamic>.from(rulesMatched!.map((x) => x)),
...
class SadhesatiCurrentStatus {
  ...
  factory SadhesatiCurrentStatus.fromJson(Map<String, dynamic> json) =>
      SadhesatiCurrentStatus(
