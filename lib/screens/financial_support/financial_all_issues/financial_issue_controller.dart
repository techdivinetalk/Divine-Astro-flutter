...
class FinancialIssuesListController extends GetxController {
  FinancialIssuesListController(this.userRepository);

  final UserRepository userRepository;
  var preference = Get.find<SharedPreferenceService>();

  var isTechnicalLoading = false.obs;
  AllFinancialIssuesModel? technicalIssuesList;
  @override
  void onInit() {
  ...
  getTechnicalTickets() async {
    ...
    try {
      ...
      final response = await userRepository.getFinancialIssuess();
