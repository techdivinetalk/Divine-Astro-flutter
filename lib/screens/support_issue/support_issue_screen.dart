...
class SupportIssueScreen extends GetView<SupportIssueController> {
  SupportIssueScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SupportIssueController>(
      init: SupportIssueController(UserRepository()),
      builder: (_) {
        return Scaffold(
          appBar: AppBar(
