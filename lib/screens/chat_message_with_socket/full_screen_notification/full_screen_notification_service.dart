...
class FullScreenNotificationService {
  static final FullScreenNotificationService _singleton = FullScreenNotificationService._internal();

  factory FullScreenNotificationService() {
    return _singleton;
  }
    ...
    await ZegoUIKitPrebuiltCallInvitationService().init(
      ...
      invitationEvents: ZegoUIKitPrebuiltCallInvitationEvents(
        ...
        onIncomingCallCanceled: (callID, caller, customData) {
          print(caller);
          print("caller.name=------onIncomingCallCanceled");
        },
        onIncomingCallDeclineButtonPressed: () {
          print("onIncomingCallDeclineButtonPressed");
        },
