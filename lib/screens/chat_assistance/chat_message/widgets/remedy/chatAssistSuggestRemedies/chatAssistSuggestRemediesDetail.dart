...
class ChatAssistSuggestRemediesDetailsPage
    extends GetView<ChatAssistSuggestRemedyDetailsController> {
  const ChatAssistSuggestRemediesDetailsPage({super.key});
