  ...
  Future<dynamic> getOrderHistory(int type, int page) async {
    ...
    try {
      ...
      if (type == 0) {
        ...
        CallOrderHistoryModelClass data = await OrderHistoryRepository().getCallOrderHistory(params);
        apiCalling.value = false;
        var history = data.data;
        ...
        GiftOrderHistoryModelClass data = await OrderHistoryRepository().getGiftOrderHistory(params);
        apiCalling.value = false;
        var history = data.data;
        ...
        RemedySuggestedOrderHistoryModelClass data = await OrderHistoryRepository().getRemedySuggestedOrderHistory(params, headers);
        apiCalling.value = false;
        var history = data.data;
