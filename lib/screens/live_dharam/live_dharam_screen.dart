...
class _LivePage extends State<LiveDharamScreen>
  ...
  //   List<GiftData> tempData = GiftsSingleton().gifts.data ?? [];
  ...
  //                             needRecharge:
  //                                 (bal.InsufficientBalModel balModel) async {
  ...
  //                                 ctx,
  //                                 GiftPlayerData(
  //                                     GiftPlayerSource.url, item.animation),
  //                               );
  //                             } else {}
