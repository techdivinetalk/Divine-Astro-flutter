...
import 'package:divine_astrologer/screens/technical_issue/issues_screen/technical_issue_controller.dart';
...
class TechnicalIssuesBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<TechnicalIssuesListController>(
        () => TechnicalIssuesListController(UserRepository()));
  }
}

class AllTechnicalIssueScreen extends GetView<TechnicalIssuesListController> {
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Align(
                                            ...
                                            child: Text(
                                              "${"ticket_no".tr} :  ${data.ticketId.toString()}",
                                              style: TextStyle(
                                    ...
                                    ListTile(
                                      contentPadding: const EdgeInsets.only(
                                          ...
                                          right: 16),
                                      title: Text(
                                        "${"ticket_type".tr} : ${data.ticketType} ${"( ${data.status_text.toString()} )"}",
                                        style: TextStyle(
